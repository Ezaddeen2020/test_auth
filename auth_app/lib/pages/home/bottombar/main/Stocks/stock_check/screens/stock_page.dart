      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('اخر التحديث:', _formatDate(firstItem.updateDate)),
          ],
        ),
      ),
    );
              ...
              children: [
                Expanded(
                  child: _buildSummaryItem(
                      'إجمالي الكمية', controller.totalStock.toStringAsFixed(2), Colors.blue, null
                      // Icons.warehouse,
                      ),
                ),
                Expanded(
                  child: _buildSummaryItem(
                      'متوسط السعر', controller.averagePrice.toStringAsFixed(2), Colors.orange, null
                      // Icons.attach_money,
                      ),
                ),
              ],
...
//     // استخدام PopScope لاعتراض عملية الرجوع
//     return PopScope(
//       canPop: true,
//       onPopInvoked: (didPop) {
//         // إلغاء عملية البحث الجارية عند الرجوع
//         controller.cancelCurrentSearch();
//       },
//       child: Scaffold(
//         backgroundColor: Colors.grey[50],
//         appBar: AppBar(
...
//           centerTitle: true,
//           iconTheme: const IconThemeData(color: Colors.white),
//           // إضافة onPressed مخصص لزر الرجوع
//           leading: IconButton(
...
//                               label: Text(
//                                 controller.isLoading.value ? 'جاري البحث...' : 'بحث',
//                                 style: const TextStyle(
//                                   fontSize: 16,
//                                   fontWeight: FontWeight.bold,
//                                   color: Colors.white,
