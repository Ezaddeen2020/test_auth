...
// TransferResponse محدث مع دعم العد الكلي للعناصر
class TransferResponse {
  ...
  TransferResponse({
    ...
    this.totalItems,
    this.itemsPerPage = 20, // القيمة الافتراضية
    required this.data,
  });
  ...
  factory TransferResponse.fromJson(Map<String, dynamic> json) {
    return TransferResponse(
      ...
      totalItems: json['totalItems'], // قد تكون null
  ...
  // معلومات مفيدة للـ pagination
  bool get hasNextPage => currentPage < totalPages;
  bool get hasPreviousPage => currentPage > 1;

  int get startItemNumber => ((currentPage - 1) * itemsPerPage) + 1;
  int get endItemNumber {
    int end = currentPage * itemsPerPage;
    if (totalItems != null && end > totalItems!) {
      return totalItems!;
    }
    return end;
  }
  ...
  String get pageInfo {
    if (totalItems != null) {
      return 'عرض $startItemNumber - $endItemNumber من أصل $totalItems';
    } else {
